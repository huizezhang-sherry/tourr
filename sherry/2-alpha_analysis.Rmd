...
Some of the series are exactly the same, the plot below filter the unique path. 
...
#### **PCA visualisation of the searching path**

- The PCA visualisation tells us that though starting from the same place, different `stepS` leads to minor different paths and ending points but the ending `index_val` is very similar
...
##### **index value plot for different stepS**

[this is interesting! investigate on directional search become less effective when stepS goes large]
