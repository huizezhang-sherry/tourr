...
```{r echo = FALSE}
knitr::include_graphics(here::here("sherry", "fig", "234.png"))
```


2) `x2, x5, x6`: without `x3`, `x5` and `x6` are more distinct and thus found 

```{r echo = FALSE}
knitr::include_graphics(here::here("sherry", "fig", "256.png"))
```


3) `x3, x5, x6`: when `x3` is added back, the tour can't find `x5, x6` again

```{r echo = FALSE}
knitr::include_graphics(here::here("sherry", "fig", "356.png"))
```
