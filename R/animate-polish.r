...
animate_polish <- function(data, tour_path = grand_tour(), display = display_xy(), start = NULL, aps = 1, fps = 30, max_frames = 200, rescale = TRUE, sphere = FALSE, alpha_polish = 0.1, ...) {
  #browser()
  if (!is.matrix(data)) {
