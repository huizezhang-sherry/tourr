...
```{r}
load(here::here("tour_optim_doc", "x2_object.rda"))
...
gganimate::animate(geo_animate, fps = 2)
...
```{r better-path}
load(here::here("tour_optim_doc", "x2_object_better.rda"))
...
load(here::here("tour_optim_doc","x2_object_better_random.rda"))
